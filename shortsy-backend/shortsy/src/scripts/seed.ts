/**
 * seed.ts — Populate the DynamoDB content table with the full content catalog.
 *
 * Usage (from shortsy-backend/shortsy/):
 *   npm run seed              # seeds dev table
 *   STAGE=prod npm run seed   # seeds prod table
 *
 * Prerequisites: AWS credentials must be configured (env vars, ~/.aws/credentials,
 * or an IAM role). The DynamoDB tables must already exist (run `serverless deploy` first).
 */
...
const TABLE  = `shortsy-content-${stage}`;
...
// ── Content catalog (mirrors src/data/mockData.ts) ────────────────────────────
const CONTENT = [
  {
    id: '1', title: 'The Last Train', type: 'short-film',
    thumbnail: 'https://images.unsplash.com/photo-1695114584354-13e1910d491b?w=1080&q=80',
    duration: '18 min', price: 49, director: 'Arjun Mehta',
    language: 'Hindi', genre: 'Drama', mood: 'Emotional',
    rating: 4.7, views: 12500,
    ...
    featured: true, featuredKey: 'true', festivalWinner: true,
  },
  {
    id: '2', title: 'Midnight Caller', type: 'vertical-series',
    thumbnail: 'https://images.unsplash.com/photo-1563905463861-7d77975b3a44?w=1080&q=80',
    duration: '2 min/ep', price: 79, director: 'Priya Sharma',
    language: 'English', genre: 'Thriller', mood: 'Suspense',
    rating: 4.8, views: 25000,
    ...
    featured: true, featuredKey: 'true', festivalWinner: false,
  },
  {
    id: '3', title: 'Colors of Home', type: 'short-film',
    thumbnail: 'https://images.unsplash.com/photo-1637217632015-d1d00b77f327?w=1080&q=80',
    duration: '25 min', price: 99, director: 'Rajesh Kumar',
    language: 'Tamil', genre: 'Family', mood: 'Heartwarming',
    rating: 4.5, views: 8900,
    description: 'A beautiful exploration of tradition and modernity through the eyes of a young girl during Diwali.',
    trailer:  'https://firebasestorage.googleapis.com/v0/b/shortsy-7c19f.firebasestorage.app/o/4220556-hd_1920_1080_30fps.mp4?alt=media&token=7892c187-adf2-46ef-a7d7-437c177ad9c3',
    videoUrl: 'https://firebasestorage.googleapis.com/v0/b/shortsy-7c19f.firebasestorage.app/o/4220556-hd_1920_1080_30fps.mp4?alt=media&token=7892c187-adf2-46ef-a7d7-437c177ad9c3',
    featured: false, featuredKey: 'false', festivalWinner: true,
  },
  {
    id: '4', title: 'City Lights', type: 'vertical-series',
    thumbnail: 'https://images.unsplash.com/photo-1688549450664-8189b4ac4751?w=1080&q=80',
    duration: '1.5 min/ep', price: 49, director: 'Sneha Das',
    language: 'Bengali', genre: 'Romance', mood: 'Late Night',
    rating: 4.3, views: 15600,
    ...
    featured: false, featuredKey: 'false', festivalWinner: false,
  },
  {
    id: '5', title: 'The Confession', type: 'short-film',
    thumbnail: 'https://images.unsplash.com/photo-1525222285365-d6bfe94ec598?w=1080&q=80',
    duration: '12 min', price: 29, director: 'Ananya Singh',
    language: 'Hindi', genre: 'Drama', mood: '5-min Heartbreak',
    rating: 4.6, views: 20100,
  ...
  {
    id: '6', title: 'Abstract Minds', type: 'short-film',
    thumbnail: 'https://images.unsplash.com/photo-1705254613735-1abb457f8a60?w=1080&q=80',
    duration: '8 min', price: 39, director: 'Vikram Patel',
    language: 'No Dialogue', genre: 'Experimental', mood: 'Artistic',
    rating: 4.4, views: 5200,
  ...
  {
    id: '7', title: 'First Love', type: 'vertical-series',
    thumbnail: 'https://images.unsplash.com/photo-1514846528774-8de9d4a07023?w=1080&q=80',
    duration: '2 min/ep', price: 69, director: 'Karan Johar Jr.',
    language: 'Hindi', genre: 'Romance', mood: 'Heartwarming',
    rating: 4.9, views: 35000,
  ...
  {
    id: '8', title: 'Behind the Lens', type: 'short-film',
    thumbnail: 'https://images.unsplash.com/photo-1514076298225-f6de8bfa58fa?w=1080&q=80',
    duration: '22 min', price: 89, director: 'Meera Nair',
    language: 'Malayalam', genre: 'Documentary', mood: 'Inspiring',
    rating: 4.7, views: 7800,
...
// ── Seed runner ───────────────────────────────────────────────────────────────
async function seed() {
  console.log(`\n🌱  Seeding ${CONTENT.length} items → ${TABLE} (${region})\n`);
  ...
  console.log(`\n✅  Done — ${CONTENT.length} items written to ${TABLE}\n`);
}
